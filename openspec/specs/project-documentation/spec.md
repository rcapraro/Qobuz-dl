...
Define what the repository's README must communicate so that visitors can evaluate, install, and use the app without building from source: visual previews of the UI, a prebuilt-artifact installation path, an end-to-end usage walkthrough, and accurate project status badges.
